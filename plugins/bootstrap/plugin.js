    ...
    var BootstrapPlugin = function () {
      function BootstrapPlugin(editor, url) {
            ...
            var _loop_1 = function (key, value) {
              if (this_1.elements[key]) {
                ...
                this_1.editor.ui.registry.addButton('bs-' + key, {
                  ...
                  onSetup: function (_buttonApi) {
                    _this.editor.editorContainer.querySelector('#bs-icon-' + key).closest('button').setAttribute('id', _this.editor.id + '-bs-btn-' + key);
        ...
        this.editor.addCommand('iframeCommand', function (ui, value) {
          ...
          _this.editor.insertContent(_this.getOutput(value));
        });
      ...
      BootstrapPlugin.prototype.getKey = function (passphrase) {
        var key = this.cjs.PBKDF2(passphrase, this.cjs.SHA256(this.getHostname()).toString(this.cjs.enc.Hex), {
          hasher: this.cjs.algo.SHA256,
          keySize: 64 / 8,
          iterations: 999
        });
        return key;
      };
      BootstrapPlugin.prototype.getOutput = function (value) {
        var code = value.outputCode;
        var key = this.getKey(this.key);
        var decrypted = this.cjs.AES.decrypt(decodeURI(code), key, { iv: this.cjs.enc.Utf8.parse('1111111111111111') });
        try {
          if (decrypted.sigBytes > 0) {
            return decrypted.toString(this.cjs.enc.Utf8);
          }
          throw new Error();
        } catch (error) {
          this.throwRegistrationAlert();
