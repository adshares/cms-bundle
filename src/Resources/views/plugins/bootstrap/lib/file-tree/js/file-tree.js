            ...
            loadFolder (folderId) {
                ...
                this.loadTemplates().then((template) => {
                    ...
                    if (this.options.okBtn === true || this.options.cancelBtn === true) {
                        ...
                        if (this.options.uploadBtn === true){
                            $targetId.querySelector('#upload-image-btn').addEventListener('click', (e) => {
                                e.preventDefault()
                                const input = document.createElement('input')
                                input.setAttribute('id', 'upload_images')
                                    ...
                                    if(img){
                                        ...
                                        xhr.onreadystatechange = async e => {
                                            if(e.currentTarget.status === 201) {
                                                ...
                                                const alert = $targetId.querySelector('.upload-status')
                                            ...
                                            if(e.currentTarget.status !== 201) {
                                                ...
                                                alert.textContent = 'Error: '+ e.currentTarget.statusText
                                            }
                                        }
                                        xhr.send(formData)
                                    }
