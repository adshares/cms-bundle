...
/**
 * An ServiceEntityRepository serves as a repository for entities with generic as well as
...
class EntityRepository implements ObjectRepository, Selectable
{
    ...
    public function createNamedQuery($queryName)
    {
        Deprecation::trigger(
            ...
            'Named Queries are deprecated, here "%s" on entity %s. Move the query logic into ServiceEntityRepository',
            $queryName,
            $this->_class->name
        );
    ...
    public function createNativeNamedQuery($queryName)
    {
        Deprecation::trigger(
            'doctrine/orm',
            'https://github.com/doctrine/orm/issues/8592',
            'Named Native Queries are deprecated, here "%s" on entity %s. Move the query logic into ServiceEntityRepository',
            $queryName,
            $this->_class->name
        );
    ...
    /**
     * Resolves a magic method call to the proper existent method at `ServiceEntityRepository`.
     *
